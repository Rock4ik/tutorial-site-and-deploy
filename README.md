...
Это мой первый полноценный веб-проект на Flask, который я разработал во время обучения. Сайт включает в себя главную страницу с навигационным меню.

### 🎯 Цели проекта:
- ✅ Освоить основы Flask framework
- ✅ Научиться работать с HTML-шаблонами
- ✅ Применить Шаблоны CSS для стилизации
- ✅ Настроить деплой на PythonAnywhere
- ✅ Создать первый работающий сайт

### Скриншоты моего сайта
![Главная страница](screenshoots/main-page.png)
